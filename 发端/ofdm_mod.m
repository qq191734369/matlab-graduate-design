...
for I_symbol = 1:num_OFDMperFrame
    %frequency mapping
    data_to_ifft([1:ifft_length])=[0 data([num_used_subcarrier/2+[1:num_used_subcarrier/2]],I_symbol).',zeros(1,ifft_length-num_used_subcarrier-1),data([1:num_used_subcarrier/2],I_symbol).']; %insert zero
